...
import JobApplicationForm from "../components/JobApplicationForm"; // Імпорт форми
...
const JobDetail = () => {
  ...
  const [showForm, setShowForm] = useState(false); // Додано стан для показу форми
          ...
          <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
            ...
            <div className='w-full'>
              {user?._id === job?.company?._id ? (
                ...
                <JobApplicationForm jobId={job?._id} onClose={() => setShowForm(false)} /> // Форма для подання заявки
              ) : (
                <CustomButton
                  title='Apply Now'
                  onClick={() => setShowForm(true)} // Показуємо форму при натисканні
